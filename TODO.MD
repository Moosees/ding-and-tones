...
* Use useCloseOutside on all popups (without overlays)?
* Responsive design - small screens in landscape over 400 px scrolls inside the borderContainer, all scroll or no scroll?
...
* NavButton for mobileUser is wonky
