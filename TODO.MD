...
* Iterate over scale notes to see if song is ready to be played - refactor to utils file and check percussive howls
...
* Add isOwner to song with scale fetch if user is owner of scale linked to song
