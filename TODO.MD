...
* set accountOpen if new user is created
...
* turn off isAddingExtraNotes and isEditingExtraPos when creating new scale, loading scale or song (setState) or fetching scale or song
