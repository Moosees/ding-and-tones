...
* allBeats populates on page load without songId
* allBeats populates on page load with correct songId
* allBeats populates on page load with incorrect songId
* allBeats populates on load song
