...
* Update cleanupHowls for new howls state structure
* Add percussive sounds to createHowls
...
* Add howls handling when loading scale
...
* Remove old howls initial state object
...
* Remove utils for old global effects
