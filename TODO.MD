...
* Custom positions for extra notes, move notes mode? - started
* Move notes on mobile, needs to be on drum route instead of scale route
* Show all positions when move mode is on and allow swapping notes
