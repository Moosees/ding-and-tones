...
* Play taks by clicking
* Tak click target style

* Sound player using howler - tweak playHowl function?
* New sounds - and sound switching working with howls
* Master volume
...
* Length of beat should be inside patterns?
