...
* Show print list and change order of chords?
* Update barMetre position if hands or count is open
* Update react DnD
...
* Help menu for intervals, explain colors and chords, help msg for empty printList for chords
* Volume controls?
