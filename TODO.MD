...
* Left and right hand recommendations for songwriter - started
* Hands in song viewer/print
* Hands in songwriter
* Get default hand when adding bars
* Show hands on/off - song viewer and writer
* Check if loaded songs has saved hands
