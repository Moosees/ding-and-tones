...
* Hover color for bar controls buttons, spacing for mute
* Clear mutedBars on new song, opacity on bars when muted?
* Position attribute for BtnIcon, use it in search results
