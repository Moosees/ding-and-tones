...
* Song viewer and print: bar numbers, play song animations, loading song sets mode to view?
...
* Signing in with a song loaded that you own should update ownership
...
* Always allow changing interval focus?
