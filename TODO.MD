...
* Save song controller
* Song search (and save) receive data on client
* Disable load song with scale button for songs without scales
* Remove parseSearchResponse?
* Check if songs without scales work
