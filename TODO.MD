...
* set CurrentDropdown to null when clicking same beat as dropdown is open on
* move next and prev dropdown to useKeyboardForDropdown?
* remove keyboard listeners when currentDropdown is null
* disable next/prev dropdown arrow at first and last beat

* allBeats populates on new song (rename setSongState)
* allBeats populates on page load without songId - working
* allBeats populates on page load with correct songId - working
* allBeats populates on page load with incorrect songId - working
* allBeats populates on load song - working
* allBeats updates when user adds bar - working
* allBeats updates when user duplicates bar - working
* allBeats updates when user deletes bar - working
* allBeats updates when user moves bar - working
* allBeats updates when user change subdivisions or metre - working

* saving song changes anything?
* Auto next beat toggle - functionality
* stop auto dropdown change when reaching last beat
* Keyboard listeners - don't move on non note inputs, arrow keys? space skips? clear beat key?
* Handle chords and auto - debounce inputs?
* Show dropdown over song controls - portal? z? html dialog?
* Better dropdown handler?
* Better arrows?
* Update help text
* Delete old createAllBeatsSnapshot? Keep muted bars skipping for dropdown?
* Better name for allBeats?
* clickOutside closes dropdown?
* move song effect from app effects to only work on song page?
...
* Replace connect with useSelector and useDispatch
...
* move logic to useSongIsPlaying
