...
* Anonymous user switch in account
* Anonymous in search results
* Scale name validation (also in songs)
* Validator errors from api to client
...
* Better Loading component - big spinner?
