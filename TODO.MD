...
* Remember sound source and volume for user

#### Needed Changes

* Frontend actions to set sound source and volume also sends request to server - use onClose function for PopupSound
* Get sound source and volume when logging in
