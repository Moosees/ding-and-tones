...
* Hover color for bar controls buttons, disabled color for difficulty dropdown arrow
* Position attribute for BtnIcon, use it in search results and to position mute bar buttons
