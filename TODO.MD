...
* Chord names with sharps
* Scale info name and notes with sharps
* MiniDrum with sharps
...
* Logic for figuring out if a note is a sharp or flat - circle of fifths + maj/min detection
