...
* add stop song playback extra reducer (changing audioSrc, replace all setIsSongPlaying false?)
...
* remove addSoundToBeat, removeSoundFromBeat and other obsolete helper functions
