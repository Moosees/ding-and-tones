...
export const beatsState = {
  ...
  cb: { sound: ['-'], value: 16, mode: 'c' },
  cc: { sound: ['T'], value: 8, mode: 'c' },
  cd: { sound: ['-'], value: 16, mode: 'c' },
  ce: { sound: ['5', '7'], value: 4, mode: 'c' },
  cf: { sound: ['-'], value: 16, mode: 'c' },
  cg: { sound: ['t'], value: 8, mode: 'c' },
  ch: { sound: ['4', '6'], value: 16, mode: 'c' },
};
